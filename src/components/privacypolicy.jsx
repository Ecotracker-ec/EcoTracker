      ...
      <div className="privacy-right">
        <div className="privacy-right-container">
          ...
          <div className="privacy-center">
            ...
            <div className="det">
              <p>Welcome to EcoTracker. We value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our <a href="#" className="link">website</a> and use our services, including our carbon footprint calculator.</p>
            </div>
            ...
            <div className="det">
              <p>The right to correct any inaccuracies in your personal information
                ...
                To exercise any of these rights, please contact us at <a href="mailto:ecotracker.ec@gmail.com" className="link">ecotracker.ec@gmail.com</a>.</p>
            </div>
            ...
            <div className="det">
              ...
              <p>
                <li>By email: <a href="mailto:ecotracker.ec@gmail.com" className="link">ecotracker.ec@gmail.com</a></li>
                <li>By visiting this page on our website: <a href="#" className="link">Contact Us</a></li></p>
            </div>
