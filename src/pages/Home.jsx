  ...
  return (
    <>
      ...
      <div className="relative w-full bg-black pb-10">
        <img src={industry} alt='Industry' className='h-[500px] w-full object-bottom object-fill md:object-cover mt-20'/>
        <div className='text-center text-[30px] md:text-[50px] mt-20 ml-10 mr-10'>
      ...
      <div className="relative w-full bg-[#e08616] pb-10">
        <img src={analysis} alt='Industry' className='h-[200px] md:h-[600px] w-full object-center object-cover mt-20'/>
        <div className='text-center text-[30px] mt-10 md:text-[50px] md:mt-20'>
          View <span className='text-[#4af41f]'>Analysis</span><br />and get <br /><span className='text-[#4af41f]'>Suggestions</span>
        </div>
        <div className='text-center text-[20px] ml-10 mr-10 md:text-[25px] mt-10'>
